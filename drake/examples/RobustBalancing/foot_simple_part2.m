...
%%Constraints
[prog, sos(1)] = spotless_add_sprocedure(prog, sos(1), V0p,V_vars,2);
[prog, sos(1)] = spotless_add_sprocedure(prog, sos(1), h_X,V_vars,degree);
[prog, sos(1)] = spotless_add_sprocedure(prog, sos(1), subs(h_X0,x,xp),V_vars,degree);

[prog, sos(2)] = spotless_add_sprocedure(prog, sos(2), h_X,[V_vars;u],degree-2);
...
[prog, sos(2)] = spotless_add_sprocedure(prog, sos(2), 1-u^2,[V_vars;u],degree-2);
