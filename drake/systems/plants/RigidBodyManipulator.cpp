    ...
    int base_or_frame_ind, int body_or_frame_ind, int gradient_order) const
{
  ...
  Transform<Scalar, 3, Isometry> Tworld_to_baseframe = isometryInverse(Tbaseframe_to_world);
...
// TrigPoly stuff:
template DLLEXPORT_RBM GradientVar<TrigPoly<double>, -1, -1, -1, -1> RigidBodyManipulator::massMatrix<TrigPoly<double> >(KinematicsCache<TrigPoly<double> >&, int) const;
//template DLLEXPORT_RBM Eigen::Matrix<TrigPoly<double>, 3, 1, 0, 3, 1> RigidBodyManipulator::centerOfMass<TrigPoly<double> >(KinematicsCache<TrigPoly<double> >&, std::__1::set<int, std::__1::less<int>, std::__1::allocator<int> > const&) const;
template DLLEXPORT_RBM GradientVar<TrigPoly<double>, -1, 1, -1, 1> RigidBodyManipulator::dynamicsBiasTerm<TrigPoly<double> >(KinematicsCache<TrigPoly<double> >&, std::__1::unordered_map<RigidBody const*, GradientVar<TrigPoly<double>, 6, 1, 6, 1>, std::__1::hash<RigidBody const*>, std::__1::equal_to<RigidBody const*>, std::__1::allocator<std::__1::pair<RigidBody const* const, GradientVar<TrigPoly<double>, 6, 1, 6, 1> > > > const&, int) const;
template DLLEXPORT_RBM GradientVar<TrigPoly<double>, 6, -1, 6, -1> RigidBodyManipulator::geometricJacobian<TrigPoly<double> >(KinematicsCache<TrigPoly<double> > const&, int, int, int, int, bool, std::__1::vector<int, std::__1::allocator<int> >*) const;
//template DLLEXPORT_RBM GradientVar<Eigen::Matrix<TrigPoly<double>, 3, -1, 0, 3, -1>::Scalar, -1, -1, -1, -1> RigidBodyManipulator::forwardKinJacobian<Eigen::Matrix<TrigPoly<double>, 3, -1, 0, 3, -1> >(KinematicsCache<Eigen::Matrix<TrigPoly<double>, 3, -1, 0, 3, -1>::Scalar> const&, Eigen::MatrixBase<Eigen::Matrix<TrigPoly<double>, 3, -1, 0, 3, -1> > const&, int, int, int, bool, int) const;
//template DLLEXPORT_RBM GradientVar<Eigen::Matrix<TrigPoly<double>, 3, -1, 0, 3, -1>::Scalar, -1, 1, -1, 1> RigidBodyManipulator::forwardJacDotTimesV<Eigen::Matrix<TrigPoly<double>, 3, -1, 0, 3, -1> >(KinematicsCache<Eigen::Matrix<TrigPoly<double>, 3, -1, 0, 3, -1>::Scalar> const&, Eigen::MatrixBase<Eigen::Matrix<TrigPoly<double>, 3, -1, 0, 3, -1> > const&, int, int, int, int) const;
//template DLLEXPORT_RBM GradientVar<TrigPoly<double>, 3, -1, 3, -1> RigidBodyManipulator::centerOfMassJacobian<TrigPoly<double> >(KinematicsCache<TrigPoly<double> >&, int, std::__1::set<int, std::__1::less<int>, std::__1::allocator<int> > const&, bool) const;
//template DLLEXPORT_RBM GradientVar<TrigPoly<double>, 6, -1, 6, -1> RigidBodyManipulator::centroidalMomentumMatrix<TrigPoly<double> >(KinematicsCache<TrigPoly<double> >&, int, std::__1::set<int, std::__1::less<int>, std::__1::allocator<int> > const&, bool) const;
//template DLLEXPORT_RBM GradientVar<TrigPoly<double>, -1, -1, -1, -1> RigidBodyManipulator::forwardKinPositionGradient<TrigPoly<double> >(KinematicsCache<TrigPoly<double> > const&, int, int, int, int) const;
template DLLEXPORT_RBM GradientVar<TrigPoly<double>, 6, 1, 6, 1> RigidBodyManipulator::geometricJacobianDotTimesV<TrigPoly<double> >(KinematicsCache<TrigPoly<double> > const&, int, int, int, int) const;
//template DLLEXPORT_RBM GradientVar<TrigPoly<double>, 3, 1, 3, 1> RigidBodyManipulator::centerOfMassJacobianDotTimesV<TrigPoly<double> >(KinematicsCache<TrigPoly<double> >&, int, std::__1::set<int, std::__1::less<int>, std::__1::allocator<int> > const&) const;
//template DLLEXPORT_RBM GradientVar<TrigPoly<double>, 6, 1, 6, 1> RigidBodyManipulator::centroidalMomentumMatrixDotTimesV<TrigPoly<double> >(KinematicsCache<TrigPoly<double> >&, int, std::__1::set<int, std::__1::less<int>, std::__1::allocator<int> > const&) const;
