...
%       pelvis_motion_data = biped.getPelvisMotionForWalking(x0, foot_motion_data, obj.supports, obj.support_times, options);
      ...
      pelvis_motion_data = biped.planWalkingPelvisMotion(obj.comtraj, obj.zmptraj, foot_motion_data, obj.supports, obj.support_times, obj.contact_groups, q0, qstar, obj.qtraj, obj.constrained_dofs, options.pelvis_height_above_sole, obj.min_knee_angle);
